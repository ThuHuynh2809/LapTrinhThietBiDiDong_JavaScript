            ...
            <View style={styles.body}>
                ...
                {/* <View style={styles.viewEdit}>
                    <Image source={require('../assets/check.png')}
                        style={styles.imgCheck}
                    />
                    <Text style={styles.textEdit}>UI task web page</Text>
                    <TouchableOpacity style={styles.btnEdit}>
                        <Image source={require('../assets/edit.png')}
                            style={styles.imgEdit}
                        />
                ...
                <View style={styles.viewEdit}>
                    <Image source={require('../assets/check.png')}
                        style={styles.imgCheck}
                    />
                    <Text style={styles.textEdit}>Learn javascript basic</Text>
                    <TouchableOpacity style={styles.btnEdit}>
                        <Image source={require('../assets/edit.png')}
                            style={styles.imgEdit}
                        />
                ...
                <View style={styles.viewEdit}>
                    <Image source={require('../assets/check.png')}
                        style={styles.imgCheck}
                    />
                    <Text style={styles.textEdit}>Learn HTML Advance</Text>
                    <TouchableOpacity style={styles.btnEdit}>
                        <Image source={require('../assets/edit.png')}
                            style={styles.imgEdit}
                        />
                ...
                <View style={styles.viewEdit}>
                    <Image source={require('../assets/check.png')}
                        style={styles.imgCheck}
                    />
                    <Text style={styles.textEdit}>Medical App UI</Text>
                    <TouchableOpacity style={styles.btnEdit}>
                        <Image source={require('../assets/edit.png')}
                            style={styles.imgEdit}
                        />
                ...
                <View style={styles.viewEdit}>
                    <Image source={require('../assets/check.png')}
                        style={styles.imgCheck}
                    />
                    <Text style={styles.textEdit}>Learn Java</Text>
                    <TouchableOpacity style={styles.btnEdit}>
                        <Image source={require('../assets/edit.png')}
                            style={styles.imgEdit}
                        />
